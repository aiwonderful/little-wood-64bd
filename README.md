...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/little-wood-64bd
```

A live public deployment of this template is available at [https://little-wood-64bd.templates.workers.dev](https://little-wood-64bd.templates.workers.dev)
